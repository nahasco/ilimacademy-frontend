...
export default function Skill_level_icon(props) {

  return (
    <svg className={`skill-level-icon ${props.subject} level-${props.level}`} width="80" height="52" viewBox="0 0 83.91 50.26" fill="none">
